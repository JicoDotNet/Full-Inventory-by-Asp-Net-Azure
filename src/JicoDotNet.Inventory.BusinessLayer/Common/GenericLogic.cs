    ...
    public class GenericLogic
    {
        ...
        public static string ConvertToWord(double amount)
        {
            try
            {
                ...
                if (amount_dec == 0)
                {
                    return Convert(amount_int) + " Rupee(s) Only.";
                }
                else
                {
                    return Convert(amount_int) + " Rupee(s) and " + Convert(amount_dec) + " Paisa Only.";
                }
            }
            catch
            {
        ...
        public static long DecodeHex(string encodeHexStr)
        {
            try
            {
                ...
                return System.Convert.ToInt64(r, 16);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static async Threading.Tasks.Task<string> BingImageUrl()
        {
            try
            {
