CREATE PROCEDURE [dbo].[spSetVendorType]
(
...
BEGIN
    ...
    BEGIN TRY
		BEGIN TRANSACTION @T1
			...
			BEGIN
				IF EXISTS (SELECT * FROM dbo.mVendorType WHERE VendorTypeId = @VendorTypeId)
				BEGIN
					UPDATE dbo.mVendorType
