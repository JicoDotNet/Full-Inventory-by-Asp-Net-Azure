CREATE PROCEDURE [dbo].[spSetVendorBank]
(
...
BEGIN
    ...
    BEGIN TRY
		BEGIN TRANSACTION @T1
			...
			BEGIN
				IF EXISTS (SELECT * FROM dbo.mVendorBank WHERE VendorBankId = @VendorBankId AND VendorId = @VendorId)
				BEGIN
					UPDATE dbo.mVendorBank
